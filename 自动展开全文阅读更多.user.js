...
(function () {
    var websites = [
        ...
        {
            match: ["*://*.sina.cn/*"],
            hide: [".read-unfold-box", "#article_end + div", "#m-sentiment3"],
        ...
        },
        {
            ...
            match: "*://www.jianshu.com/p/*",
            hide: [".call-app-btn", "#jianshu-header", "#note-show .content .show-content-free .collapse-tips", ".download", ".note-comment-above-ad-wrap", ".close-collapse-btn", ".open-app-btn", ".app-open", "#guangtui", "#fixed-ad-container", ".fubiao-dialog"],
